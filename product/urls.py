...
from product.views import ( 
    ...
    CustomerCreateOrderWithVariantsView,
...
urlpatterns = [ 
    ...
    path('promo/', PromoCodeListView.as_view(), name='promo_code_list'),
    path('promo/<str:code>/', PromoCodeDetailView.as_view(), name='promo_code_detail'),
