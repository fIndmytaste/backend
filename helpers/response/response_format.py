...
def paginate_success_response_with_serializer(request, serializer, data=[], page_size=10, addition_serializer_data=None, extra_serializer_context=None):
    ...
    if extra_serializer_context:
        serializer_context.update(extra_serializer_context)
    transactions_serializer = serializer(page.object_list, many=True, context=serializer_context)
